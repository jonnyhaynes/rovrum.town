...
> _Aye, that Rotherham. Said proper._
...
Warm, cheeky, unmistakably **local** — but still credible. The name _Rovrum_ is how a Rotherham accent says "Rotherham"; the brand is in on the joke and proud of it. Lean on light dialect (_aye, tha', an', reyt, faffing_) as seasoning, not as a full phonetic rewrite. Keep the layout/visuals clean so the voice reads as confident, not gimmicky.

- **Do:** "Everything Rovrum, in one spot." / "We'll give tha' a shout."
- **Don't:** write whole paragraphs in heavy phonetics, or mock the accent. It's _by us, for us_.
...
| **Paper**      | `#f7f5f2` | Light ground (warm off-white — _not_ pure white)                      |
...
<link
  rel="stylesheet"
  href="https://fonts.bunny.net/css?family=bitter:600,700,700i|inter:400,600"
/>
```
...
- **Tagline:** Bitter _italic_ (700i), in Rovrum Red.
...
### Web — broadsheet treatment

The **website** is deliberately styled as a **broadsheet newspaper front page**:
masthead with a folio line and double rule, a dominant lead story, a secondary
stack, a three-column run, and hairline column dividers. This is an intentional
shift from the "contemporary, not newspapery" note above — the newspaper metaphor
fits a local news product, and the feel comes from **layout, rules and density**,
not new fonts. We keep the same Bitter + Inter pairing and the one-red-accent rule.
See `docs/plans/news-broadsheet-design.md`.
...
| **Instagram**          | 320×320               | _(no cover)_                       | Circle avatar only.                                            |
| **LinkedIn** (Company) | 300×300               | **1128×376**                       | Use `rovrum-cover-linkedin-1128x376.png`.                      |
| **TikTok**             | 200×200+              | _(no cover)_                       | Circle avatar only. Keep monogram bold — shown small.          |
...
### Facebook _(Page — short intro + longer About)_
...
### LinkedIn _(Company — tagline + About; lighter on dialect for the professional context)_
